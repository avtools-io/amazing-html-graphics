...
- [EBU HTML Graphics Working Group](https://tech.ebu.ch/groups/html-graphics) – The EBU group coordinating the open, interoperable HTML graphics work that includes OGraf.
...
- [OrkasVideoStudio](https://github.com/Orkas-AI/Orkas-VideoStudio) – **Open source (MIT).** **Authoring, export, rendering, integration.** Lets coding agents compose HTML motion graphics, edit media, and render editable `plan.json` timelines locally.
